...
_bt_getbuf(Relation rel, BlockNumber blkno, int access)
{
	 ...
	 * Saving value of pages_read counter
	 */
	double temp_total_read_pages = pages_read;
	...
	/*
	 * Added on 12/05/2015 for QUEST
	 * Checking page is actually read or not
	 */
	if(pages_read != temp_total_read_pages)
		increase_counter_by_one(index_pages_read);

...
transformSelectStmt(ParseState *pstate, SelectStmt *stmt)
{
	...
	/* @kuntal*/
	qry->clausesel = transformInjectedClause(pstate, pstate->clausesel,EXPR_KIND_INJECTED_CLAUSE,"SELECTIVITY");
	qry->selec = pstate->selec;
...
transformExplainStmt(ParseState *pstate, ExplainStmt *stmt)
{
	...
	//@kuntal Selectivity injection
	pstate->clausesel = stmt->clausesel;
	pstate->selec = stmt->selec;
